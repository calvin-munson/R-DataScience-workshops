...
At the end of this worksheet, I ask you to play around with the data and send me a graph (or multiple!) that you feel conveys interesting new information about this dataset. If you feel comfortable doing so, feel free to email me or the whole group your output at calvin_munson@alumni.brown.edu. And if you have any further questions about the data or the code, please do not hesitate to reach out!!
